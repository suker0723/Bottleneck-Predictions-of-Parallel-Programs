// parallel scan, but separate the parallel parts
// two parallel regions and one sequential partial sum
// potential bottlenecks: 1. lack of parallelism due to the sequential part
//                        2. overheads of threads management
#include <algorithm>
#include <stdio.h>
#include <math.h>
#include <omp.h>
